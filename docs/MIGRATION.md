...
## Android
Install suyu without uninstalling yuzu. After that, use an file managing application to manually move saves and roms across from yuzu to suyu by going into each directory and finding the relevant folders.
