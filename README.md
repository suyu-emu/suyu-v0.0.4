...
This repo is is currently based on Eden, with the code being "evolved" from the core upward to combat legal and performance related concerns.
...
Bus_Error/Crimson Hawk and his "friends" are no longer affiliated with the project due to an internal fallout with the dev team.
