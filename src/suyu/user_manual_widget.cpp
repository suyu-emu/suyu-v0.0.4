...
void UserManualWidget::LoadDefaultContent() {
    browser_->setHtml(QStringLiteral(
        ...
        "<li>If the game needs decryption support, open <b>Tools → Configure External Decryption Tool</b> and select hactool or another supported external tool.</li>"
        ...
        "<p>If the emulator fails to start, check the log file from <b>Help → Open Log Location</b>. Common issues include incorrect firmware, unsupported file formats, or a missing external decryption tool configuration for encrypted content.</p>"
        "<h2>Advanced Tips</h2>"
        "<ul>"
