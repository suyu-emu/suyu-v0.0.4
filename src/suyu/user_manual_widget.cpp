...
void UserManualWidget::LoadDefaultContent() {
    browser_->setHtml(QStringLiteral(
        ...
        "<li>If you update keys while the library is open, SuyuEclipse now refreshes the content providers and repopulates the game list safely.</li>"
        "</ul>"
        "<h2>Game Library</h2>"
        ...
        "<ul>"
        "<li>Use <b>Sign in with Browser</b> for the streamlined path.</li>"
        ...
        "<p>SuyuEclipse detects Steam automatically and can add your games as non-Steam shortcuts. This allows launcher and overlay support without requiring a Steam API key.</p>"
        ...
        "<h2>Advanced Tips</h2>"
        "<ul>"
        "<li>Use the embedded docs pane for the public online docs and this lower guide for SuyuEclipse-specific behavior.</li>"
