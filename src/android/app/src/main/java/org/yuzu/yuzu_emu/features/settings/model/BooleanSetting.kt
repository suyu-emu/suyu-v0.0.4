...
enum class BooleanSetting(override val key: String) : AbstractBooleanSetting {
    ...
    DYNA_STATE_1("dyna_state_1"),
    DYNA_STATE_2("dyna_state_2"),
    DYNA_STATE_2_EXTRAS("dyna_state_2_extras"),
    DYNA_STATE_3("dyna_state_3"),
    DYNA_STATE_3_blend("dyna_state_3_blend"),
