...
constexpr auto compile_time_hash =
    "0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef"_HASH;
...
TEST_CASE("_HASH operator", "[crypto]") {
    SECTION("Invalid length returns empty hash") {
        ...
        auto hash3 =
            "0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcde"_HASH; // 63 chars
        auto hash4 =
            "0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef0"_HASH; // 65 chars
    ...
    SECTION("Valid 64-character hex string conversion") {
        ...
        SHA256Hash expected{0x01, 0x23, 0x45, 0x67, 0x89, 0xab, 0xcd, 0xef, 0x01, 0x23, 0x45,
    ...
    SECTION("Real SHA256 hash example") {
        ...
        SHA256Hash expected{0xe3, 0xb0, 0xc4, 0x42, 0x98, 0xfc, 0x1c, 0x14, 0x9a, 0xfb, 0xf4,
    ...
    SECTION("Invalid hex characters return empty hash") {
        ...
        auto hash1 =
            "gggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggg"_HASH; // 64 'g' chars
        auto hash2 =
            "0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdeg"_HASH; // 'g' at end
        auto hash3 =
            "0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcd@g"_HASH; // '@' and 'g'
        auto hash4 =
            "0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcd z"_HASH; // space and
                                                                                     // 'z'
    ...
    SECTION("Edge case hex characters") {
        ...
        auto hash1 =
            "0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcd/0"_HASH; // '/' is
                                                                                     // before '0'
        auto hash2 =
            "0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcd:0"_HASH; // ':' is after
                                                                                     // '9'
        auto hash3 =
            "0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcd`0"_HASH; // '`' is
                                                                                     // before 'a'
        auto hash4 =
            "0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdg0"_HASH; // 'g' is after
                                                                                     // 'f'
        auto hash5 =
            "0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcd@0"_HASH; // '@' is
                                                                                     // before 'A'
